    ...
    <section id="about" className="min-h-screen flex flex-col items-center justify-center px-5 sm:px-8 md:px-10 py-20 relative">
      ...
      <div className="flex flex-col items-center gap-16 sm:gap-20 md:gap-24 max-w-4xl w-full relative z-10">
        <div className="flex flex-col items-center gap-10 sm:gap-14 md:gap-16 w-full">
          ...
          <AnimatedText
            text="
        Fullstack Developer with experience since 2022 delivering web applications across diverse projects — ranging from e-commerce and payment systems to data automation and AI-driven products. Proficient across the full stack, from building responsive user interfaces to designing scalable backends and database architectures. Experienced in integrating AI capabilities, including LLM-powered features, RAG pipelines, and voice AI systems. Passionate about the intersection of modern web engineering and applied AI, with a strong ability to thrive in fast-paced environments focused on solving real-world problems.
          "
        ...
        <FadeIn delay={0.3} y={20}>
          <ContactButton href="mailto:usamahhafidz99@gmail.com" />
        </FadeIn>
      </div>
    </section>
  );
